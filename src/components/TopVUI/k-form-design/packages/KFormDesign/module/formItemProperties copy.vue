  ...
  <div class="properties-centent kk-checkbox">
    ...
    <div class="properties-body">
      ...
      <a-form v-show="selectItem.key !== ''">
        ...
        <template
          v-if="
            selectItem.type == 'treeSelect' || selectItem.type == 'cascader'
          "
        >
        ...
        <a-form-item v-if="selectItem.type === 'grid'" label="表格样式">
          <kCheckbox
        ...
        <!-- <a-form-item v-if="selectItem.type === 'grid'" label="栅格高度">
          <div class="flex">
            <a-input-number
              :min="0"
              style="width: 80%;"
        ...
        <a-form-item v-if="selectItem.type === 'grid'" label="布局模式">
          <a-radio-group
            buttonStyle="solid"
        ...
        <a-form-item v-if="selectItem.type === 'color'" label="默认值">
          <div class="flex">
            <a-input
        ...
        <a-form-item v-if="selectItem.type === 'userPop'" label="默认值">
          <TSelectUserByDep
            v-model="options.defaultValue"
            :multiple="options.multiple"
          ></TSelectUserByDep>
        </a-form-item>
        <a-form-item v-if="selectItem.type === 'area'" label="默认值">
          <TAreaLinkage v-model="options.defaultValue" :type="options.areaType">
          </TAreaLinkage>
        </a-form-item>
        <a-form-item v-if="selectItem.type === 'icon'" label="默认值">
          <iconFontPicker v-model="options.defaultValue"> </iconFontPicker>
        </a-form-item>

        <a-form-item v-if="selectItem.type === 'depart'" label="默认值">
        ...
        <!-- 省市区级联选择器的类型 -->
        <a-form-item v-if="selectItem.type === 'area'" label="类型">
          <a-radio-group
            buttonStyle="solid"
        ...
        <a-form-item v-if="selectItem.type === 'card'" label="边框">
        ...
        <a-form-item v-if="selectItem.type === 'uploadImg'" label="上传方式">
        ...
        <a-form-item v-if="selectItem.type === 'text'" label="字体大小">
          <div>
            <a-input-number
              style="width: 80% !important;"
        ...
        <a-form-item v-if="selectItem.type === 'text'" label="字体颜色">
          <div class="flex">
            <a-input
              style="width: 80% !important;"
        ...
        <a-form-item v-if="selectItem.type === 'text'" label="字体样式">

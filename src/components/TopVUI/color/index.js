                    ...
                    t = function(h, e) {
                            ...
                            for (e in f = oe.support = {},
                                ...
                                oe.matchesSelector = function(e, t) {
                                    if ((e.ownerDocument || e) !== x && m(e),
                                        t = t.replace(G, "='$1']"), !(!f.matchesSelector || !A || a && a.test(t) || v && v.test(t)))
                                        try {
                                            var n = s.call(e, t);
                                                ...
                                                function(e, t, n) {
                                                    ...
                                                    if (d) {
                                                        ...
                                                        if (l = [A ? d.firstChild : d.lastChild],
                                                            ...
                                                            for (;
                                                                (i = ++s && i && i[c] || (a = s = 0) || l.pop()) && ((v ? i.nodeName.toLowerCase() !== u : 1 !== i.nodeType) || !++a || (p && ((i[B] || (i[B] = {}))[f] = [k, a]),
                                                                    i !== e));)
                                                        ;
                                    ...
                                    if (n = n || [],
                                        ...
                                        for (o = Q.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !b.relative[s = a.type]);)
                                            if ((l = b.find[s]) && (r = l(a.matches[0].replace(re, u), te.test(i[0].type) && ue(t.parentNode) || t))) {
                                                if (i.splice(o, 1), !(e = r.length && fe(i)))
                                                    return F.apply(n, r),
                                                        n;
                                                break
                                            }
                        ...
                        C.event = {
                                        ...
                                        for (c = (t = (t || "").match(E) || [""]).length; c--;)
                                            if (f = g = (s = Q.exec(t[c]) || [])[1],
                                                ...
                                                for (u = C.event.special[f] || {},
                                                    ...
                                                    l = i = p.length; i--;)
                                                    a = p[i], !o && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(i, 1),
                                ...
                                trigger: function(e, t, n, r) {
                                    ...
                                    if (3 !== n.nodeType && 8 !== n.nodeType && !V.test(u + C.event.triggered) && (0 <= u.indexOf(".") && (u = (p = u.split(".")).shift(),
                                        ...
                                        for (c = 0;
                                            (f = d[c++]) && !e.isPropagationStopped();)
                                            e.type = 1 < c ? a : s.bindType || u,
                                            (o = (C._data(f, "events") || {})[e.type] && C._data(f, "handle")) && o.apply(f, t),
                                            (o = i && f[i]) && o.apply && C.acceptData(f) && (e.result = o.apply(f, t), !1 === e.result && e.preventDefault());
                                    ...
                                    if ((a[0] = e).delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, e)) {
                                        for (i = C.event.handlers.call(this, e, s),
                                            ...
                                            for (e.currentTarget = r.elem,
                                                o = 0;
                                                (n = r.handlers[o++]) && !e.isImmediatePropagationStopped();)
                                ...
                                mouseHooks: {
                                    ...
                                    filter: function(e, t) {
                                        ...
                                        return null == e.pageX && null != t.clientX && (r = (n = e.target.ownerDocument || B).documentElement,
                                                ...
                                                e.pageY = t.clientY + (r && r.scrollTop || n && n.scrollTop || 0) - (r && r.clientTop || n && n.clientTop || 0)), !e.relatedTarget && i && (e.relatedTarget = i === e.target ? t.toElement : i),
                            ...
                            C.extend({
                                clone: function(e, t, n) {
                                    ...
                                    if (A.html5Clone || C.isXMLDoc(e) || !re.test("<" + e.nodeName + ">") ? i = e.cloneNode(!0) : (ge.innerHTML = e.outerHTML,
                                            ge.removeChild(i = ge.firstChild)), !(A.noCloneEvent && A.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                                        for (r = me(i),
                                            s = me(e),
                                            a = 0; null != (o = s[a]); ++a)
                                            r[a] && function(e, t) {
                        ...
                        C.extend({
                                    ...
                                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                                        ...
                                        if ("string" === (i = void 0 === n ? "undefined" : on(n)) && (o = Pe.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(C.css(e, t)),
                                            ...
                                            null != n && n == n && ("number" !== i || C.cssNumber[s] || (n += "px"),
                                                A.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r)))))
                                            try {
                                                l[t] = n
                                            } catch (e) {}
                                    }
                                ...
                                css: function(e, t, n, r) {
                                    ...
                                    return t = C.cssProps[i] || (C.cssProps[i] = Ge(e.style, i)),
                                        ...
                                        "" === n || n ? (t = parseFloat(o), !0 === n || C.isNumeric(t) ? t || 0 : o) : o
                                }
                            }),
                        ...
                        C.Animation = C.extend(pt, {
                                tweener: function(e, t) {
                                    for (var n, r = 0, o = (e = C.isFunction(e) ? (t = e, ["*"]) : e.split(" ")).length; r < o; r++)
                                        n = e[r],
                                        lt[n] = lt[n] || [],
                                        lt[n].unshift(t)
                                },
                                ...
                                ajax: function(e, t) {
                                    ...
                                    for (n in (u = C.event && f.global) && 0 == C.active++ && C.event.trigger("ajaxStart"),
                                        ...
                                        f.hasContent || (f.data && (l = f.url += (wt.test(l) ? "&" : "?") + f.data,
                                            delete f.data), !1 === f.cache && (f.url = Et.test(l) ? l.replace(Et, "$1_=" + Bt++) : l + (wt.test(l) ? "&" : "?") + "_=" + Bt++)),
                                    ...
                                    function s(e, t, n, r) {
                                        ...
                                        2 !== y && (y = 2,
                                            ...
                                            a = function(e, t, n, r) {
                                                ...
                                                for (i = d.shift(); i;)
                                                    if (e.responseFields[i] && (n[e.responseFields[i]] = t), !l && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)),
                                                        l = i,
                                                        i = d.shift())
                                                        if ("*" === i)
                                                            i = l;
                ...
                a.prototype = {
                    ...
                    initCurrentColorBox: function() {
                        ...
                        this.curcolordom = document.createElement("div"),
                            ...
                            this.curcolordom.onclick = function(e) {
                                !t.option.disabled&&t.changeShow()
                            },
                            this.option.show && (0,
                    ...
                    addBlurEvent: function() {
                        ...
                        this.dom.querySelector("input").onblur = function(e) {
                            t.initColorFormat(t.dom.querySelector(".current-color-value input").value),
                                t.fillOpacity(),
                                t.fillPalette(),
                                t.addHistoryColors()
                        }
                        ...
                        i.dom.addEventListener("mousedown", function(e) {
                                ...
                                o = null,
                                    ...
                                    (n = n.parents(".gradient-item")[0] ? n.parents(".gradient-item") : n).hasClass("gradient-item") && (a.isGradientBar = !0,
                                        ...
                                        a.$ele = n),
                                    n.hasClass("add-gradient") && (r.gradientColor.arry.colors.push({
                                            per: 100,
                                            color: "#ffffff"
                                        }),
                            ...
                            switch (e) {
                                case "hue":
                                    this.huebar.style.top = i + "%",
                                        c = "hsla(" + 360 * i / 100 + "," + this.color.hslav[1] + "%," + this.color.hslav[2] + "%," + this.color.hslav[3] + ")";
                                    break;
                                case "lightness":
                    ...
                    fillPalette: function() {
                        var e, t, n;
                        this.ctxlightness && (this.ctxlightness.fillStyle = "hsla(" + this.color.hslav[0] + ",100%,50%,1)",

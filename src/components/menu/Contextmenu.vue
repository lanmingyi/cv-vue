 ...
 * @LastEditTime: 2021-08-10 10:44:38
 * @LastEditors: 黄婷
 * @FilePath: \vite-demoe:\wwwroot\Vue\MisBoot\misboot-cloud-vue\src\components\menu\Contextmenu.vue
-->
<template>
  <a-menu
    v-show="visible"
...
export default {
  ...
  created() {
    ...
    window.addEventListener("contextmenu", this.setPosition, false);
  },
  beforeDestroy() {

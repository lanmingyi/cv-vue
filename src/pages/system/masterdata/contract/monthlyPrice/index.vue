      ...
      <tool-bar @search="$refs.table.refresh(true)"
        ...
        <template slot="toolBtn" slot-scope="scope">
          ...
          <a-button class="cu-btn-primary" icon="export"
                    @click="handleExportXls(columns, 'contract_price', 1)" v-action:contractPriceExcelExportDialog>
            导出
          </a-button>
...
export default {
  ...
  data() {
    return {
      ...
      queryParam: {},
      url: {
        getPageSet: '/bdata/monthlyPrice/getPageSet',
        // save: '/contract/contractPrice/save',
        // update: '/contract/contractPrice/update',
        // deleteBatch: '/contract/contractPrice/deleteBatch',
        // exportExcelUrl: "/contract/contractPrice/exportExcel",
        // importExcelUrl: "/contract/oilListingPrice/exportleadingIn",
      },

		...
		<div class="page-common-content">
			...
			@reset="() => {(this.queryParam = {}), $refs.table.refresh(true);}">
				...
				<template slot="toolBtn" slot-scope="scope">
					<a-button class="cu-btn-primary" icon="plus" @click="handleAdd()" v-action:oilListingPriceAddDialog>
						新增
					</a-button>
					<a-button class="cu-btn-primary" icon="edit" @click="handleEdit($refs.table.rows)"
						v-action:oilListingPriceEditDialog>编辑 </a-button>

					<!-- <a-upload
					  name="file"
					  :showUploadList="false"
					  :multiple="false"
					  v-action:oilListingPriceExcelImportDialog
					...
					<a-button class="cu-btn-primary" icon="export"
						@click="handleExportXlsTest(columns, 'oil_listing_price', 1, $refs.table.selectedRowKeys)" v-action:oilListingPriceExcelExportDialog>
						导出
					</a-button>
					<a-button class="cu-btn-danger" icon="delete" @click="handleSub($refs.table.selectedRowKeys)"
						v-action:oilListingPriceDelDialog>删除
					</a-button>
				</template>
	...
	export default {
		...
		data() {
            ...
            fixed: 'right',
				...
				queryParam: {},
				url: {
					getPageSet: '/bdata/oilListingPrice/getPageSet',
					save: '/bdata/oilListingPrice/save',
					update: '/bdata/oilListingPrice/update',
					deleteBatch: '/bdata/oilListingPrice/deleteBatch',
					exportExcelUrl: "/bdata/oilListingPrice/exportExcel",

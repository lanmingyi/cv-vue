    ...
    <a-col flex="1 1 750px">
      <div id="printBox">
        <a-card class="seal-card padding-bottom-sm" :bordered="false" >
          ...
          <div v-html="html" class="padding-lr"></div>
					<!-- <div>
						<img style="width: 730px;height: 830px;" src="https://cbu01.alicdn.com/img/ibank/O1CN01TE3g191lVthSGAIr9_!!3283754825-0-cib.jpg" />
					</div> -->
          <!-- 文本 -->
          ...
          <div class="drag-box" v-dragBox v-if="showDrag">

	...
	<a-form :form="form">
		<div class="account-center-avatarHolder">
			<table class="table-ant" style="table-layout: fixed; word-break: break-all;">
				<thead>
					<tr>
						<th colspan="6" style="text-align: center;padding-bottom: 30px;">借款申请单</th>
					</tr>
				</thead>
				<tr>
				...
				<tr class="table_tr">
					...
					<td colspan="2">
						<a-form-item>
							<a-input
								...
								readOnly
							>
								<a-icon slot="prefix" type="user" :disabled="isView" />
							</a-input>
						</a-form-item>
					</td>
					<td>借款单位</td>
					<td colspan="2">
						<a-form-item>
							<a-input
								v-decorator="['loanDepartmentName', { rules: [{ required: true, message: '必填！' }] }]"
								readOnly
								:disabled="isView"
							/>
						</a-form-item>
				...
				<tr class="table_tr">
					...
					<td colspan="2">
						<a-form-item>
							<a-input
								v-decorator="[
									'loanMoney',
									{ initialValue: loanMoney, rules: [{ required: true, message: '必填！' }] },
								]"
								@change="changeNum"
								:disabled="isView"
							/>
					...
					<td colspan="2">
						<a-form-item>
							<a-input
								v-decorator="['loanMoneyCapitalization', { initialValue: loanMoneyCapitalization }]"
								readOnly
								:disabled="isView"
							/>
						</a-form-item>
...
export default {
	...
	methods: {
		...
		select(value, node, extra) {
			this.$nextTick(() => {
				this.form.setFieldsValue({
					loanDepartmentName: node.dataRef.text,
					loanDepartmentId: node.dataRef.id,
				});
			});
		},
	},

	...
	<a-form :form="form">
		<div class="account-center-avatarHolder">
			<table class="table-ant" style="table-layout: fixed; word-break: break-all;">
				<thead>
					<tr>
						<th colspan="6" style="text-align: center;padding-bottom: 30px;">付款申请单</th>
					</tr>
				</thead>
				<tr>
				...
				<tr class="table_tr">
					...
					<td colspan="2">
						<a-form-item>
							<t-date
								v-decorator="['collectionDateStr', { rules: [{ required: true, message: '必填！' }] }]"
								style="width: 100%;"
								dateFormat="YYYY-MM-DD HH:mm:ss"
								allowClear
							/>
				...
				<tr class="table_tr">
					...
					<td colspan="2">
						<a-form-item>
							<a-input
								v-decorator="['paymentMoney', { rules: [{ required: true, message: '必填！' }] }]"
								@change="changeNum"
							/>
						</a-form-item>
					</td>

<template>
	<j-modal :visible="visibleType" :width="800" title="编号发文" :fullscreen="fullscreen" :switchFullscreen="fullscreen"
							...
							<a-card :bordered="false">
								<div class="box_container">
									<div class="box_art">
										...
										<div class="box_filelist flex align-start" v-show="!fileName">
											<a-button class="cu-btn-primary" v-if="fileNameList.length == 0"
												icon="upload" @click="documentAdd">
												新建公文
											</a-button>
											<a-upload :multiple="true" :file-list="fileNameList"
												:remove="handleRemoveName" :before-upload="beforeUploadName"
												@preview="handlePreview">
												<a-button class="cu-btn-success margin-left"
													v-if="fileNameList.length == 0" @click="
                            () => {
                              changeType == 'document';
                            }
                          ">
									...
									<div class="box_art">
										...
										<div class="box_filelist">
											<a-upload :multiple="true" :file-list="fileList" :remove="handleRemove"
												:before-upload="beforeUpload" @preview="previewFile">
												<a-button class="cu-btn-primary" @click="
                            () => {
                              changeType == 'file';
                            }
                          ">
										...
										<thead>
											<tr>
												<th colspan="6" style="text-align: center;padding-bottom: 30px;">
													<a-form-item>
														<a-input class="text-center" v-decorator="['title']"
															placeholder="公文标题" disabled />
													</a-form-item>
												</th>
											</tr>
										</thead>
										<tr>
											...
											<td colspan="2">
												<a-form-item>
													<a-input
														style="border-bottom: 1px solid #e7e7e7;border-radius: inherit;"
														v-decorator="['applicantTime']" disabled />
												</a-form-item>
											</td>
										</tr>
										<tr class="table_tr">
											...
											<td colspan="2">
												<a-form-item>
													<a-input v-decorator="['paymentReason']" disabled />
												</a-form-item>
											</td>
											<td>收文时间</td>
											<td colspan="2">
												<a-form-item>
													<a-input v-decorator="['paymentUnit']" disabled />
												</a-form-item>
											</td>
										</tr>
										<tr class="table_tr">
											...
											<td colspan="5">
												<a-form-item>
													<a-input type="textarea" :rows="4"
														...
														v-decorator="['paymentReason']" disabled />
												</a-form-item>
											</td>
										</tr>
										<tr class="table_tr">
										...
										<tr class="table_tr">
											...
											<td colspan="5">
												<a-form-item>
													<a-input type="textarea" :rows="4"
														style="width: 100%;height: 100%;margin-top: 5px;"
														v-decorator="['leaderReview']" disabled />
												</a-form-item>
												<a-form-item>
					...
					<a-tab-pane v-if="type == 'view'" key="3" tab="流程流转">
						<div class="box_art">
							<s-table ref="table" size="small" :columns="columns" :data="loadData" bordered
								:pageSize="10" rowKey="uuid" showPagination="auto" :rowClassName="rowClassName"
								:customRow="rowClick">

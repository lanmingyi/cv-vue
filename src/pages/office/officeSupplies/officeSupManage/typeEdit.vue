				...
				<a-row :gutter="24" type="flex" justify="start">
					...
					<a-col :span="24">
						<a-form-item label="分类名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
							<a-input v-decorator="['assetStatus', { rules: [{ required: true, message: '必填' }] }]" />
						</a-form-item>
					</a-col>
					<a-col :span="24">
						<a-form-item label="说明" :labelCol="labelCol" :wrapperCol="wrapperCol">
							<a-input
								type="textarea"
								v-decorator="['title', { rules: [{ required: true, message: '必填' }] }]"
							/>
						</a-form-item>
					</a-col>
					<a-col :span="24">
...
// 表单字段
const fields = ['uuid', 'assetStatus', 'title', 'assetName'];

				...
				<tool-bar @search="$refs.masterList.refresh(true)" @reset="
				  ...
				  ">
					...
					<template slot="toolForm">
						<a-form-item label="">
							<a-input v-model="masterQueryParam.senderName" placeholder="发件人" />
						</a-form-item>
					</template>
				</tool-bar>
	...
	export default {
		...
		data() {
			return {
				...
				mdlUserPost: {},
				url: {
					masterList: "/office/oaEmailReceive/getPageSet",
					masterDelete: "/office/oaEmailReceive/deleteBatch",
					masterAdd: "/office/oaEmailReceive/save",
					masterUpdate: "/office/oaEmailReceive/update",

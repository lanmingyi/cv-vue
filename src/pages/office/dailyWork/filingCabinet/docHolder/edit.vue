				...
				<a-row :gutter="24" type="flex" justify="start">
					<a-col :span="24">
						<a-form-item label="所属部门" :labelCol="labelCol" :wrapperCol="wrapperCol">
							<a-input v-decorator="['department', { rules: [{ required: true, message: '必填' }] }]" />
						</a-form-item>
					</a-col>
					<a-col :span="24">
						<a-form-item label="资产名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
							<a-input v-decorator="['assetName', { rules: [{ required: true, message: '必填' }] }]" />
						</a-form-item>
					</a-col>
					<a-col :span="24">
						<a-form-item label="资产编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
							<a-input v-decorator="['assetId', { rules: [{ required: true, message: '必填' }] }]" />
						</a-form-item>
					</a-col>
					<a-col :span="24">
						<a-form-item label="领用理由" :labelCol="labelCol" :wrapperCol="wrapperCol">
							<a-input
								type="textarea"
								v-decorator="['reason', { rules: [{ required: true, message: '必填' }] }]"
							/>
						</a-form-item>
					</a-col>
					<a-col :span="24">
						<a-form-item label="归还日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
							<a-input v-decorator="['returnTime', { rules: [{ required: true, message: '必填' }] }]" />
						</a-form-item>
					</a-col>
					<a-col :span="24">
...
// 表单字段
const fields = ['uuid', 'department', 'assetName', 'assetId', 'reason', 'returnTime'];

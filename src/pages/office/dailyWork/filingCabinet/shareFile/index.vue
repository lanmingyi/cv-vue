    ...
    <a-card :bordered="false">
      <div class="toolbar flex justify-between flex-wrap" style="width: 100%;">
        <div class="table-operator">
          <!-- <a-button class="cu-btn-primary" icon="plus" @click="handleaddArchivePost">多文件上传</a-button> -->
          <!-- <a-button class="cu-btn-danger" icon="delete" @click="handleSub('all','sub')">删除</a-button> -->
          <!-- <a-button class="cu-btn-default"
            icon="edit">共享</a-button> -->
        </div>
        <div class="table-page-search-wrapper">
          <a-form layout="inline">
            <div class="flex justify-between flex-wrap">
              <a-form-item label="">
                <a-input v-model="queryParam.trainName" placeholder="文件名" />
              </a-form-item>
              <a-form-item label="">
                <a-input v-model="queryParam.content" placeholder="文件内容" />
              </a-form-item>

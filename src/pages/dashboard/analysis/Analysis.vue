...
<script>
import ChartCard from '@/components/antd/card/ChartCard'
import MiniArea from '@/components/antd/chart/MiniArea'
import MiniBar from '@/components/antd/chart/MiniBar'
import MiniProgress from '@/components/antd/chart/MiniProgress'
import Bar from '@/components/antd/chart/Bar'
import RankingList from '@/components/antd/chart/RankingList'
import HotSearch from './HotSearch'
import SalesData from './SalesData'
import Trend from '@/components/antd/chart/Trend'

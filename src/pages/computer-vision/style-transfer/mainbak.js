...
class Main {
  ...
  initializeStyleTransfer() {
    ...
    this.contentSelect.onchange = (evt) => {
      console.log('evt', this.contentSelect)
      console.log('evt', this.contentSelect.value)
      this.setImage(this.contentImg, evt.target.value);

    }
    this.contentSelect.onclick = (e) =>{
      console.log('e', this.contentSelect.value)
      this.contentSelect.value = '';
    }
  ...
  setImage(element, selectedValue) {
    ...
    if (selectedValue === 'file') {
      console.log('this.fileSelect', this.fileSelect)

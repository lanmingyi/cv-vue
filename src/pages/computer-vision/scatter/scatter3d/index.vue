<template>
  <div align="center">
    ...
    <p>
      ...
      <a-form label-width="100px" inline>
        <a-col :span="8">
...
/** data */
import getTrainData from "@/components/cv/scatter3d/lib/traindata.ts";
/** model */
import {
  createModel,
  convertToTensor,
  trainModel,
  testModel
} from "@/components/cv/scatter3d/lib/model.ts";
/** components */
import ChartData from "@/components/cv/scatter3d/components/ChartData";
import ChartPerformanceLoss from "@/components/cv/scatter3d/components/ChartPerformanceLoss";
import ChartPerformanceMse from "@/components/cv/scatter3d/components/ChartPerformanceMse";

...
/** data */
import getTrainData from "@/components/cv/scatter3d2/lib/traindata.ts";
/** model */
import {
  createModel,
  convertToTensor,
  trainModel,
  testModel
} from "@/components/cv/scatter3d2/lib/model.ts";
/** components */
import ChartData from "@/components/cv/scatter3d2/components/ChartData";
import ChartPerformanceLoss from "@/components/cv/scatter3d2/components/ChartData";
import ChartPerformanceMse from "@/components/cv/scatter3d2/components/ChartData";

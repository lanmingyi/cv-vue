var dicOption = {
  ...
  position: [{ label: '居中', value: 'center' }, { label: '左对齐', value: 'left' }, { label: '右对齐', value: 'flex-end' }],
  ...
  dataList: ['tabs','map', 'video', 'wordcloud', 'pie', 'pictorialBar', 'iframe', 'swiper', 'flop', 'bar', 'line', 'progress', 'table', 'gauge', 'funnel', 'scatter', 'radar',
      'terminal','trend','coolrd-map','virual-map','slippage','markMap','pictorialbar'],
  themeList: [{
    label: '默认配色',
    value: 'xvue'
  }, {
